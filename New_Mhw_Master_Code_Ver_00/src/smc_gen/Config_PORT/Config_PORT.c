...
void R_Config_PORT_Create(void)
{
    ...
    /* Set PORT2 registers */
    PORT2.PCR.BYTE = _00_Pm6_PULLUP_OFF | _00_Pm7_PULLUP_OFF;
    PORT2.PMR.BYTE = _00_Pm6_PIN_GPIO | _00_Pm7_PIN_GPIO;
    PORT2.PDR.BYTE = _00_Pm6_MODE_INPUT | _00_Pm7_MODE_INPUT | _3F_PDR2_DEFAULT;

    /* Set PORT3 registers */
    PORT3.ODR1.BYTE = _00_Pm6_CMOS_OUTPUT | _00_Pm7_CMOS_OUTPUT;
    PORT3.PCR.BYTE = _00_Pm0_PULLUP_OFF | _00_Pm1_PULLUP_OFF;
    PORT3.PMR.BYTE = _00_Pm0_PIN_GPIO | _00_Pm1_PIN_GPIO | _00_Pm5_PIN_GPIO;
    PORT3.PDR.BYTE = _00_Pm0_MODE_INPUT | _00_Pm1_MODE_INPUT | _00_Pm5_MODE_INPUT | _1C_PDR3_DEFAULT;
 ...
 //   PORTA.PMR.BYTE = _00_Pm6_PIN_GPIO;
    ...
    /* Set PORTC registers */
    PORTC.PODR.BYTE = _00_Pm4_OUTPUT_0 | _00_Pm5_OUTPUT_0 | _00_Pm6_OUTPUT_0;
    ...
    PORTC.DSCR.BYTE = _00_Pm4_HIDRV_OFF | _00_Pm5_HIDRV_OFF | _00_Pm6_HIDRV_OFF;
    PORTC.PMR.BYTE = _00_Pm4_PIN_GPIO | _00_Pm5_PIN_GPIO | _00_Pm6_PIN_GPIO;
    PORTC.PDR.BYTE = _10_Pm4_MODE_OUTPUT | _20_Pm5_MODE_OUTPUT | _40_Pm6_MODE_OUTPUT | _0F_PDRC_DEFAULT;

    /* Set PORTE registers */
    PORTE.PODR.BYTE = _00_Pm1_OUTPUT_0 | _00_Pm2_OUTPUT_0;
    PORTE.ODR0.BYTE = _00_Pm1_CMOS_OUTPUT | _00_Pm2_CMOS_OUTPUT | _00_Pm3_CMOS_OUTPUT;
    PORTE.ODR1.BYTE = _00_Pm4_CMOS_OUTPUT;
    PORTE.DSCR.BYTE = _00_Pm1_HIDRV_OFF | _00_Pm2_HIDRV_OFF;
    PORTE.PMR.BYTE = _00_Pm1_PIN_GPIO | _00_Pm2_PIN_GPIO;
    PORTE.PDR.BYTE = _02_Pm1_MODE_OUTPUT | _04_Pm2_MODE_OUTPUT | _E1_PDRE_DEFAULT;
