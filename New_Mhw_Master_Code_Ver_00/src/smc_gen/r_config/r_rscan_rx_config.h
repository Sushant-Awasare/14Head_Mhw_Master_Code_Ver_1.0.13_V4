 ...
 */
#define CAN_CFG_INT_PRIORITY            (14)         /* 0-31 */
...
#define CAN_CFG_INT_DLC_ERR                 (1)     /* CAN_EVT_GLOBAL_ERR       CAN_STAT_GLOBAL_ERR */
...
#define CAN_CFG_INT_MBX_TX_COMPLETE         (1)     /* CAN_EVT_TRANSMIT         CAN_STAT_CH_TXMBX_SENT */
#define CAN_CFG_INT_MBX_TX_ABORTED          (1)     /* CAN_EVT_TRANSMIT         CAN_STAT_CH_TXMBX_ABORTED */
#define CAN_CFG_INT_BUS_ERROR               (1)     /* CAN_EVT_CHANNEL_ERR      CAN_STAT_CH_ERROR */
#define CAN_CFG_INT_ERR_WARNING             (1)     /* CAN_EVT_CHANNEL_ERR      CAN_STAT_CH_ERROR */
...
#define CAN_CFG_INT_OVERLOAD_FRAME_TX       (1)     /* CAN_EVT_CHANNEL_ERR      CAN_STAT_CH_ERROR */
#define CAN_CFG_INT_BUS_LOCK                (1)     /* CAN_EVT_CHANNEL_ERR      CAN_STAT_CH_ERROR */
#define CAN_CFG_INT_ARB_LOST                (1)     /* CAN_EVT_CHANNEL_ERR      CAN_STAT_CH_ERROR */
