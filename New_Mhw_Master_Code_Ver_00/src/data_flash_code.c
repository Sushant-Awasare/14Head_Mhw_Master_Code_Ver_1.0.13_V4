...
static uint32_t gs_flash_dm_work[314/sizeof(uint32_t)];
#else
...
void flash_write_data()
{
	...
	gs_test_w_buff[109]= BAW_1.Word_Val; //All Head Modes  //changes done on 31/07/2023
	write_run_data(gs_test_w_buff);
}
...
void flash_read_data()
{
	...
	BAW_1.Word_Val = gs_test_r_buff[109]; //All Head Modes //changes done on 31/07/2023
}
